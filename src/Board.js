    ...
    this.dragula.on("drop", (el, target, source, sibling) => {
      ...
      if (client.status !== status) {
        ...
        this.setState(
          (prevState) => ({
            clients: {
              backlog: prevState.clients.backlog.filter(
                (client) => client.status === "backlog"
              ),
              inProgress: prevState.clients.inProgress.filter(
                (client) => client.status === "in-progress"
              ),
              complete: prevState.clients.complete.filter(
            ...
            this.setState((prevState) => ({
              clients: {
                backlog: [
                  ...
                  ...clients.filter((client) => client.status === "backlog"),
                ],
                inProgress: [
                ...
                complete: [
                  ...
                  ...clients.filter((client) => client.status === "complete"),
                ],
              },
            }));
          }
